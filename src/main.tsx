...
function Layout({children}:{children:React.ReactNode}){
  ...
  const headerTitle=isRecommendation?(project.company?project.customerName:project.locationName):isSizingFlow?'Nouveau devis':pathname.includes('devis')?'Devis':pathname.includes('dimension')?'Dimensionnements':'Djua';
