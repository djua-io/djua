...
function InstallationDetail(){
  ...
  const periodDetails:{[key:string]:{chartDate:string;productionLabel:string;productionValue:string}}={
    ...
    '7 derniers jours':{chartDate:'10 – 16 avr. 2025',productionLabel:'7 derniers jours',productionValue:installation.production==='Normale'?'33,6 kWh':'21,7 kWh'},
    '30 derniers jours':{chartDate:'18 mars – 16 avr. 2025',productionLabel:'30 derniers jours',productionValue:installation.production==='Normale'?'142,8 kWh':'93,4 kWh'},
