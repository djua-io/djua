...
function InstallationDetail(){
  ...
  return <section className="installationDetailPage">
    ...
    <section className="installationMetricGrid">
      <Metric icon={I.Sun} title="Production solaire" kind="normal"><div className="twoValues"><span><small>Aujourd’hui</small><b>{production}</b></span><span><small>Actuellement</small><b>{currentProduction}</b></span></div></Metric>
