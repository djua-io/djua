...
function QuoteList(){
  ...
  return <section className="page workspacePage quoteListPage">
    <div className="workspaceHeading quoteListIntro"><h1>Devis</h1><p>Suivez vos propositions commerciales et les clients à relancer.</p></div>
...
function ParcSolaire(){
  ...
  return <section className="workspacePage parcSolarPage">
    <div className="workspaceHeading parcSolarHead"><div><h1>Parc solaire</h1><p>Vue d’ensemble de toutes vos installations connectées.</p></div><button className="parcDateRange"><I.CalendarDays size={17}/>30 derniers jours<I.ChevronDown size={16}/></button></div>
...
function ProductsCatalogue(){
  ...
  const [enabled,setEnabled]=useState(()=>Object.fromEntries(catalogueProducts.map((product,index)=>[index,product.used])))
  const visibleProducts=catalogueProducts.filter(product=>{
    ...
    const matchesUsage=usage==='Tous'||(usage==='Utilisés'?enabled[catalogueProducts.indexOf(product)]:!enabled[catalogueProducts.indexOf(product)])
