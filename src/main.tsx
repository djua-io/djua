...
const parkInstallations=[
  {id:'INS-00482',client:'Jean Kabeya',site:'Maison individuelle',location:'Gombe',production:'Normale',consumption:'Normale',boxStatus:'À vérifier',boxNeedsCheck:true,global:'Critique',last:'Il y a 7 h',status:'critical' as ParkStatus},
  {id:'INS-00841',client:'Kivu Market SARL',site:'Commerce',location:'Gombe',production:'Plus faible',consumption:'Normale',boxStatus:'En place · intact',boxNeedsCheck:false,global:'À surveiller',last:'Il y a 15 min',status:'watch' as ParkStatus},
  {id:'INS-00912',client:'Sarah Ilunga',site:'Maison individuelle',location:'Ngaliema',production:'Normale',consumption:'Plus élevée',boxStatus:'En place · intact',boxNeedsCheck:false,global:'À surveiller',last:'Il y a 1 h',status:'watch' as ParkStatus},
  {id:'INS-01024',client:'École La Source',site:'École',location:'Kintambo',production:'Normale',consumption:'Normale',boxStatus:'Scellé intact',boxNeedsCheck:false,global:'Critique',last:'Il y a 2 h',status:'critical' as ParkStatus},
  {id:'INS-01108',client:'Martin Paluku',site:'Maison individuelle',location:'Limete',production:'Normale',consumption:'Plus faible',boxStatus:'En place · intact',boxNeedsCheck:false,global:'À surveiller',last:'Il y a 4 h',status:'watch' as ParkStatus}
]
const parkAlerts=[
