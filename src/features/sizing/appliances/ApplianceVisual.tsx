import { Building2, DoorClosed, Lightbulb, Plug } from 'lucide-react'
...
const iconByVisual: Partial<Record<ApplianceVisualKey, typeof Plug>> = {
  elevator: Building2,
  gate: DoorClosed,
  'safety-light': Lightbulb,
}
...
export function ApplianceVisual({ name, variant = 'row', className = '' }: { name: string; variant?: ApplianceVisualVariant; className?: string }) {
  ...
  const Icon = (visual && iconByVisual[visual]) || Plug
