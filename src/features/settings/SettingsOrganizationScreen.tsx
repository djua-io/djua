...
const organisationDetails = [
  ['Nom de l’organisation', 'Orange Énergie'],
  ...
  ['Contact principal', 'contact@orange-energie.cd · +243 81 23 45 678'],
] as const
  ...
  return <section className="workspacePage settingsPage">
    ...
    <div className="settingsLayout">
      ...
      <main className="settingsMain settingsOrganizationMain">
        ...
        <section className="settingsCard settingsOrganizationGeneral"><header><Building2 size={22} /><h3>Informations générales</h3></header><dl>{organisationDetails.map(([label, value]) => <div key={label}><dt>{label}</dt><dd>{editing ? <input defaultValue={value} /> : value}</dd></div>)}</dl></section>
