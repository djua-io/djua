...
import { BuildingSizingPage, SizingProjectTypePage } from '../features/sizing'
...
export function App() {
  return (
    <BrowserRouter basename={import.meta.env.BASE_URL}>
      <DjuaApp newSizingEntry={<SizingProjectTypePage />} buildingSizingEntry={<BuildingSizingPage />} />
    </BrowserRouter>
  )
}
