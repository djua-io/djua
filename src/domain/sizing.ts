export type Appliance = { id: string; name: string; category: string; watts: number; hours: number; quantity: number; period: 'Jour'|'Nuit'|'Les deux'; brand?: string; detailLabel?: string; detail?: string; notes?: string }
